...
def LMS_MSE(input_data, desired, order, delay, step_size, sqrt_power):
    ...
    for i in range(500):
        ...
        if i >= (200 - order):
            input_data = np.hstack((input_data[:i + order], y_temp))
            # if e_temp >= sqrt_power / 3:
            #     print(i)
            #     break
...
def LMS_MCC(input_data, desired, order, delay, step_size, kernel_size2, sqrt_power):
    ...
    for i in range(500):
        if i >= (200 - order):
            save_matrix[i] = np.hstack((save_matrix[i - 1], y_temp))[1:]
            # if e_temp >= sqrt_power / 3:
            #     print(i)
            #     break
...
def QKLMS_MSE(input_data, desired, order, delay, step_size, kernel_size, threshold, sqrt_power):
    ...
    for step in range(1, length):
        # if step >= (200 - order):
        #     save_matrix[step] = np.hstack((save_matrix[step - 1], y_temp))[1:]
            # if e_temp >= sqrt_power/3:
            #     print(step)
            #     break
...
def QKRLS_MSE(input_data, desired, order, delay, lamda, forget_factor, kernel_size, threshold, sqrt_power):
    ...
    for step in range(1, length):
        # print(step)
        # if step >= (200 - order):
        #     save_matrix[step] = np.hstack((save_matrix[step - 1], y_temp[0]))[1:]
            # if e_temp >= sqrt_power / 3:
            #     print(step)
            #     break
        element = save_matrix[step]
...
if __name__ == '__main__':
    ...
    # LMS-mse
    step_size = 0.01
    # y_pred, e, w = LMS_MSE(input_data, desired, order, delay, step_size,sqrt_power)
    # fig = plt.figure(figsize=(16, 9), dpi=100)
    # plt.plot(y_pred[:500], label="y_pred")
    # plt.plot(desired[:500], label="desired")
    # plt.xlabel("Samples", fontsize=14)
    # plt.ylabel("Observations", fontsize=14)
    # plt.title("Generating 800 trajectory in LMS-MSE")
    # plt.legend()
    # plt.savefig("LMS-MSE.png")
    # plt.show()
    ...
    kernel_size2 = 1
    # y_pred, e = LMS_MCC(input_data, desired, order, delay, step_size,kernel_size2,sqrt_power)
    # fig = plt.figure(figsize=(16, 9), dpi=100)
    # plt.plot(y_pred[:500], label="y_pred")
    # plt.plot(desired[:500], label="desired")
    # plt.xlabel("Samples", fontsize=14)
    # plt.ylabel("Observations", fontsize=14)
    # plt.title("Generating 800 trajectory in LMS-MCC")
    # plt.legend()
    # plt.savefig("LMS-MCC.png")
    # plt.show()
    ...
    # plt.xlabel("Samples", fontsize=14)
    # plt.ylabel("Observations", fontsize=14)
    # plt.title("Generating 800 trajectory in QKLMS-MSE, threshold = {}".format(threshold),fontsize=18)
    # plt.legend()
    # plt.savefig("QKLMS-MSE.png")
    # plt.show()
    ...
    # plt.xlabel("Samples",fontsize=14)
    # plt.ylabel("Observations",fontsize=14)
    # plt.title("Generating 800 trajectory in QKLMS-MCC, threshold = {}".format(threshold),fontsize=18)
    # plt.legend()
    # plt.savefig("QKLMS-MCC.png")
    # plt.show()
    ...
    # plt.xlabel("Samples", fontsize=14)
    # plt.ylabel("Observations", fontsize=14)
    # plt.title("Generating 800 trajectory in QKRLS-MSE, threshold = {}".format(threshold), fontsize=18)
    # plt.legend()
    # plt.savefig("QKRLS-MSE.png")
    # plt.show()
    ...
    # plt.xlabel("Samples", fontsize=14)
    # plt.ylabel("Observations", fontsize=14)
    # plt.title("Generating 800 trajectory in QKRLS-MCC, threshold = {}".format(threshold), fontsize=18)
    # plt.legend()
    # plt.savefig("QKRLS-MCC.png")
    # plt.show()

    threshold_list = [0.1, 0.6, 1.1, 1.6, 2.1]

    fig = plt.figure(figsize=(16, 9), dpi=100)

    for step in range(5):
        threshold = threshold_list[step]
        tic1 = time.perf_counter()
        # y_pred, e = QKLMS_MSE(input_data, desired, order, delay, step_size, kernel_size, threshold, sqrt_power)
        # y_pred, e = QKLMS_MCC(input_data, desired, order, delay, step_size, kernel_size, kernel_size2, threshold, sqrt_power)
        # y_pred, e = QKRLS_MSE(input_data, desired, order, delay, lamda, forget_factor, kernel_size, threshold, sqrt_power)
        y_pred, e = QKRLS_MCC(input_data, desired, order, delay, lamda, forget_factor, kernel_size, kernel_size2, threshold, sqrt_power)
        ...
        plt.plot(x, mse_list, label="threshold = {},running time = {}".format(threshold,round(time1,2)))
        plt.xlabel("Samples", fontsize=14)
        plt.ylabel("MSE", fontsize=14)
        plt.legend(loc="upper right")
        plt.grid()
        plt.title("learning curve of QKRLS_MCC in different threshold", fontsize=18)
        plt.savefig("QKRLS_MCC1.png")
    plt.show()
